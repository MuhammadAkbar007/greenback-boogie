package com.example.asobimasu.gravityBalls;
...
public class GravityBallsMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSimulationView.setBackgroundResource(R.drawable.gravity_balls_background);
        ...
        class ParticleSystem {
            ...
            ParticleSystem() {
                ...
                for (int i = 0; i < mBalls.length; i++) {
                    ...
                    mBalls[i].setBackgroundResource(R.drawable.gravity_balls_ball);
