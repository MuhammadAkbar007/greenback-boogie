...
public class SettingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soundOnButton = (RadioButton) findViewById(R.id.soundOnRadio);
        soundOffButton = (RadioButton) findViewById(R.id.soundOffRadio);
...
//        CurrentActivity.this.startActivity(myIntent);
        ...
        myIntent.putExtra(AppConstants.SOUND_KEY,isSoundEnabled);
