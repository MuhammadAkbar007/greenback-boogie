...
package com.example.android_jigsaw_puzzle.dao.impl;


import static com.example.android_jigsaw_puzzle.util.Base64Util.base64ToBitmap;
import static com.example.android_jigsaw_puzzle.util.DBUtil.ALL_COLUMNS;
import static com.example.android_jigsaw_puzzle.util.DBUtil.DESC_COLUMN;
import static com.example.android_jigsaw_puzzle.util.DBUtil.ID_COLUMN;
import static com.example.android_jigsaw_puzzle.util.DBUtil.ID_SELECTION;
import static com.example.android_jigsaw_puzzle.util.DBUtil.IMAGE_COLUMN;
import static com.example.android_jigsaw_puzzle.util.DBUtil.JIGSAW_TABLE;
import static com.example.android_jigsaw_puzzle.util.DBUtil.NAME_COLUMN;
import static com.example.android_jigsaw_puzzle.util.DBUtil.ORIGINAL_COLUMN;
import static com.example.android_jigsaw_puzzle.util.DBUtil.ORIGINAL_SELECTION;
import static com.example.android_jigsaw_puzzle.util.DBUtil.ORIGINAL_SELECTION_NULL;
import static com.example.android_jigsaw_puzzle.util.DBUtil.getIdArguments;
import static com.example.android_jigsaw_puzzle.util.EntityUtil.entityToContentValues;
...
import com.example.android_jigsaw_puzzle.dao.ImageDao;
import com.example.android_jigsaw_puzzle.db.JigsawDB;
import com.example.android_jigsaw_puzzle.model.ImageEntity;

import java.util.ArrayList;
import java.util.List;

/**
 * Default implementation for {@link ImageDao}. Provides CRUD database operations for {@link
 * ImageEntity}
 *
