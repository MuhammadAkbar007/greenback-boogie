...
import static com.example.snake2.AppConstants.Direction.RIGHT;
...
import com.example.snake2.SnakeHelper.DrawControl;
import com.example.snake2.SnakeHelper.SnakeMovement;
...
public class SnakeView extends SurfaceView implements Runnable {
    ...
    public void updateGame() {
        ...
        if (detectDeath()) {
            ...
            ((SnakeActivity) m_context).finish();
